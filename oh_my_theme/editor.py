    ...
    while True:
        ...
        for i in range(list_height):
            ...
            if list_idx < len(color_items):
                ...
                if (
                    segment_id in modified_colors
                    and color_type in modified_colors[segment_id]
                ):
    ...
    while True:
        ...
        if key in (curses.KEY_BACKSPACE, 127):
            ...
            if len(input_text) < 50:  # Reasonable limit
                input_text = (
                    input_text[:cursor_pos] + chr(key) + input_text[cursor_pos:]
                )
                cursor_pos += 1
...
def _create_color_display_text(
    segment_type: str,
    color_type: str,
    color_value: str,
    is_modified: bool,
